  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: [
        ...
        'web-app-manifest-192x192 copy.png',
        'web-app-manifest-512x512 copy.png',
      ],
      manifest: {
        name: 'Exponab General Trading LLC',
        short_name: 'Exponab',
        description: 'Agriculture export-import management app',
        theme_color: '#085b39',
        ...
        icons: [
          {
            src: '/web-app-manifest-192x192 copy.png',
            sizes: '192x192',
            type: 'image/png',
            purpose: 'any',
          },
